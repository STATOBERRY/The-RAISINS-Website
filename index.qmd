...
<div class="container px-4">
  <div class="row row-cols-1 row-cols-md-2 gx-3 gy-2 mt-2">
    ...
    <div class="col d-flex">
      <a class="btn btn-outline-primary text-start small py-1 px-3 mb-2 flex-grow-1"
         href="REG.qmd"
         title="Regression Anlaysis">
         Regression Anlaysis<span class="blink-new">New Release: 08/10/2025</span>
      </a>
    </div>
    <!-- Cluster anlaysis -->
    <div class="col d-flex">
      <a class="btn btn-outline-primary text-start small py-1 px-3 mb-2 flex-grow-1"
         ...
         Cluster Anlaysis<span class="blink-new">New Release: 16/10/2025</span>
      </a>
    </div>
