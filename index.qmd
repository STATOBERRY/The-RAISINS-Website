...
<a class="btn btn-outline-dark" data-bs-toggle="collapse" href="#aboutRAISINS" role="button" aria-expanded="false" aria-controls="aboutRAISINS"> <i class="bi bi-info-circle-fill"></i> More Info </a> 
<a href="citation.qmd" class="btn btn-outline-success"> <i class="bi bi-journal-arrow-up"></i> Cite us </a> 
<a href="tutorial.qmd" class="btn btn-outline-info"> <i class="bi bi-book-half"></i> Tutorial </a> 
<a href="policy.qmd" class="btn btn-outline-warning"> <i class="bi bi-shield-lock"></i> Policy </a> 
<a href="issue.qmd" class="btn btn-outline-secondary"> <i class="bi bi-bug"></i> Report a Bug </a> 
<a href="discuss.qmd" class="btn btn-outline-primary"> <i class="bi bi-chat-dots"></i> Discuss </a> 
<a href="#analysis-module" class="btn btn-outline-success"> <i class="bi bi-rocket"></i> Start </a>
<a href="RAOne.qmd" class="btn btn-outline-danger"> <i class="bi bi-robot"></i> Ask RA-One </a>
:::  
  ...
  <div class="row row-cols-1 row-cols-md-2 gx-3 gy-2 mt-2">
    ...
    <div class="col">
      <a class="btn btn-outline-primary text-start small py-1 px-3 mb-2 w-100"
         ...
         Repeated Measures ANOVA (Two way) <span class="blink-new">New Release: 06/08/2025</span>
      </a>
    </div>
