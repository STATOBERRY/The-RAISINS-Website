...
categories: [Multivariate,Social-science,Agri-research,Plant-breeding, Fruit-science]
date: 2025-11-01
reading-time: 10  
...
Head to [www.raisins.live](https://www.raisins.live) where you can access various analytical modules. You can accesss the Cluster Analysis Module from the Analysis module under Analysis of Experiments. See @fig-cluana to get started with Cluster Analysis in RAISINS

![Cluster analysis in RAISINS](CLUSANA.webp){#fig-cluana fig-align="center" width="100%"}

## How to Prepare Your Data?

Proper data preparation is crucial for accurate HCA results in RAISINS. What truly matters is the quality of your data! As the saying goes, "garbage in, garbage out" - and this holds true for any software.

*To prepare your dataset for analysis in RAISINS, you have two options*:

1.  Create your dataset in MS Excel, see @sec-cr
2.  Build your dataset directly within the RAISINS app, see @sec-crapp

### Creating a Data File in MS Excel {#sec-cr}
...
![Model1 showing how the prepared Excel file for upload should look like](cr.webp){#fig-modata1 fig-align="center" width="75%"}
...
### Creating Data Using the App (Recommended Method) {#sec-crapp}

*See @fig-cr and follow the below steps to create data in RAISINS*
...
-   Upload the Prepared CSV/XLS File: Go to the `Analysis tab`(See @fig-modata2) and upload your prepared data file by clicking `Browse`.
...
](Classical.webp){#fig-8 fig-align="center" width="100%"}
:::
...
![**Heatmap in RAISINS**](HMap.webp){#fig-hp fig-align="center" width="100%"}
...
![**Distance Matrix in RAISINS**](Distance_matrix.webp){#fig-dm fig-align="center" width="100%"}
...
![**Cluster wise means in RAISINS**](Cluster_wise_means.webp){#fig-cwm fig-align="center" width="100%"}
...
![**Intracluster statistics**](Intracluster_statistics.webp){#fig-itra fig-align="center" width="100%"}
...
![**Intercluster statistics**](Intercluster_statistics.webp){#fig-iter fig-align="center" width="100%"}
...
![**PCA Summary Table**](ClusSum.webp){#fig-pca width="100%"}
