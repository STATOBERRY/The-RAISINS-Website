...
<body>  
  ...
  <!-- App iframe -->
  <iframe src="https://rzp.io/rzp/pooled2rbdpay" onload="document.getElementById('loader').style.display='none';"></iframe>

  <!-- Floating Action Button (FAB) -->
<div class="fab-container">
  <div class="fab-button" onclick="toggleFAB()">🔙</div>
  <a href="../P2FRBD.html" class="fab-home" id="fabHome" title="Return to Pooled Two Factor Factorial RBD App">📊 App</a>
</div>
