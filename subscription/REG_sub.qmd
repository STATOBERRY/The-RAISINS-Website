...
<body>  
  ...
  <!-- App iframe -->
  <iframe src="https://rzp.io/rzp/VnUiH92" onload="document.getElementById('loader').style.display='none';"></iframe>

  <!-- Floating Action Button (FAB) -->
<div class="fab-container">
  <div class="fab-button" onclick="toggleFAB()">🔙</div>
  <a href="../REG.html" class="fab-home" id="fabHome" title="Return to Path Analysis App">📊 App</a>
</div>
