...
<body>  
  ...
  <!-- App iframe -->
  <iframe src="https://rzp.io/rzp/cabbagepay" onload="document.getElementById('loader').style.display='none';"></iframe>

  <!-- Floating Action Button (FAB) -->
<div class="fab-container">
  <div class="fab-button" onclick="toggleFAB()">🔙</div>
  <a href="../cabbage.html" class="fab-home" id="fabHome" title="Return to EFA App">📊 App</a>
</div>
