...
<body>  
  ...
  <!-- App iframe -->
  <iframe src="https://rzp.io/rzp/ancovarbdpay" onload="document.getElementById('loader').style.display='none';"></iframe>

  <!-- Floating Action Button (FAB) -->
<div class="fab-container">
  <div class="fab-button" onclick="toggleFAB()">🔙</div>
  <a href="../ancovarbd.html" class="fab-home" id="fabHome" title="Return to ANCOVA(RBD) App">📊 App</a>
</div>
