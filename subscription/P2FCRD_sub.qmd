...
<body>  
  ...
  <!-- App iframe -->
  <iframe src="https://rzp.io/rzp/pooled2fcrdpay" onload="document.getElementById('loader').style.display='none';"></iframe>

  <!-- Floating Action Button (FAB) -->
<div class="fab-container">
  <div class="fab-button" onclick="toggleFAB()">🔙</div>
  <a href="../2FCRD.html" class="fab-home" id="fabHome" title="Return to Two Factor Factorial CRD App">📊 App</a>
</div>
