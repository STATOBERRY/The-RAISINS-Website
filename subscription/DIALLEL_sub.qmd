...
<body>  
  ...
  <!-- App iframe -->
  <iframe src="https://rzp.io/rzp/diallelpay" onload="document.getElementById('loader').style.display='none';"></iframe>

  <!-- Floating Action Button (FAB) -->
<div class="fab-container">
  <div class="fab-button" onclick="toggleFAB()">🔙</div>
  <a href="../DIALLEL.html" class="fab-home" id="fabHome" title="Return to DIALLEL App">📊 App</a>
</div>
