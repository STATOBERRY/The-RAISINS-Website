...
<body>  
  ...
  <!-- App iframe -->
  <iframe src="https://rzp.io/rzp/CFBDpay" onload="document.getElementById('loader').style.display='none';"></iframe>

  <!-- Floating Action Button (FAB) -->
<div class="fab-container">
  <div class="fab-button" onclick="toggleFAB()">🔙</div>
  <a href="../CFBD.html" class="fab-home" id="fabHome" title="Return to CFBD App">📊 App</a>
</div>
